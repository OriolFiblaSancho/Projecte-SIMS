<div class="absolute top-20 left-4 z-10 bg-[#CB97FF] rounded-md p-4 shadow-lg hidden md:block border border-[#7E3FBC] max-h-[calc(100vh-6rem)] overflow-y-auto scrolling-touch"
    id="adminMenu">
        ...
        <ul class="flex">
            <li class="border-r border-[#7E3FBC]">
                <a href="?admin=ViewUsers"
                    class="text-center mx-3 hover:bg-[#d5c3eb] font-medium text-md text-[#2d0a4a]">Users</a>
            </li>
            <li class="border-r border-[#7E3FBC]">
                <a href="?admin=ViewVehicles"
                    class="text-center mx-3 hover:bg-[#d5c3eb] font-medium text-md text-[#2d0a4a]">Vehicles</a>
            </li>
            <li class="">
                <a href="?admin=ViewGeofencing"
                    class="text-center mx-3 hover:bg-[#d5c3eb] font-medium text-md text-[#2d0a4a]">Geofencing</a>
            </li>
        </ul>
    </nav>
    <?php
