<div>
    <form class="mt-5" action="/students/store" method="POST">
        <label for="vehicle_model" class="block text-sm font-medium text-gray-700 mb-1">Vehicle Model</label>
        <input type="text" name="vehicle_model" placeholder="Vehicle Model" class="border border-gray-300 rounded-md p-2 w-full mb-4">
        ...
        <select name="vehicle_type" class="border border-gray-300 rounded-md p-2 w-full mb-4">
