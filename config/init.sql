...
-- PostgreSQL-compatible schema with lowercase, unquoted identifiers and CHECK constraints instead of MySQL enums
...
CREATE TABLE users (
  ...
  user_type TEXT CHECK (user_type IN ('customer','end_customer')),
...
CREATE TABLE vehicles (
  ...
  status TEXT CHECK (status IN ('available','reserved','in_use','maintenance','out_of_service')),
